...
from ..context_classes import BasePermissionContext
from ..models import UserGrant

action_list = [('can_view:module', {'country_code': "MX"})]


class PermissionContext(BasePermissionContext):

    def context_data(self):
        permissions = [('can_view:module', {'country_code': "MX"})]
        return permissions


@permission_required(permission_class=PermissionContext)
def view(*args, **kwargs):
    return Response()


@api_permission_required(permission_class=PermissionContext)
def api_view(*args, **kwargs):
    return Response()


class ContextClassTestCase(TestCase):
